...
fun OTPScreen(optNumbersState: MutableList<String>) {
    Column(
        ...
        PrimaryText(
            text = UiText.Resource(cahatia.feature.login.generated.resources.Res.string.confirm_email)
                .asString(),
        ...
        PrimaryText(
            ...
            text = UiText.Resource(cahatia.feature.login.generated.resources.Res.string.confirm_email_description)
                .asString(),
...
//        Spacer(modifier = Modifier.weight(0.1f))
        ...
        PrimaryButton(
            ...
            text = UiText.Resource(cahatia.feature.login.generated.resources.Res.string.continue_text)
                .asString(),
            onClick = { /*TODO*/ },
